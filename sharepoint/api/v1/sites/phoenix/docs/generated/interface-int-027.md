# Interface Specification — INT-027: S/4 billing document to EDI invoice (INVOIC)
...
**Frequency:** Hourly batch · **Expected Wave 1 volume:** ~1,400 IDocs/day

## Business purpose

Released billing documents are transmitted as INVOIC messages, replacing the legacy invoice spool for EDI customers. The interface is one of the 84 in Wave 1 scope; the Wave 1 estate is 61 flows on the BTP Integration Suite, 15 direct IDoc or RFC connections retained for legacy EDI, and 8 file-based flows that are marked for retirement in Wave 2.
...
| Alert threshold | 2 consecutive failures or a backlog older than 18 minutes |
