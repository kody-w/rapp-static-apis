# Interface Specification — INT-011: Ariba invoice to S/4 supplier invoice

**Pattern:** SAP BTP Integration Suite · **Wave:** 1 · **Register:** architecture stream site → Documents → Integration
**Business owner:** Procurement (MM/Ariba) — Priya Sharma (backup Luis Ortega) · **Technical owner:** Elena Petrova (Technical Architecture & Basis), developer Marco Bianchi
**Source:** SAP Ariba Invoicing · **Target:** S/4HANA (S4P)
**Frequency:** Every 15 minutes · **Expected Wave 1 volume:** ~1,200 documents/day

## Business purpose

Supplier invoices captured on the Ariba Network post as parked or posted supplier invoices under the harmonised matching tolerance. The interface is one of the 84 in Wave 1 scope; the Wave 1 estate is 61 flows on the BTP Integration Suite, 15 direct IDoc or RFC connections retained for legacy EDI, and 8 file-based flows that are marked for retirement in Wave 2.

## Systems and endpoints

| Attribute | Value |
|-----------|-------|
| Source system | SAP Ariba Invoicing |
...
| Alert threshold | 2 consecutive failures or a backlog older than 37 minutes |
