# Interface Specification — INT-056: S/4 Universal Journal extract to analytics warehouse
...
**Source:** S/4HANA (S4P) · **Target:** Group analytics warehouse
**Frequency:** Nightly 01:30 CET · **Expected Wave 1 volume:** ~2.4M rows/night

## Business purpose

A delta extract of ACDOCA line items feeds the group management reporting layer that survives Wave 1 unchanged. The interface is one of the 84 in Wave 1 scope; the Wave 1 estate is 61 flows on the BTP Integration Suite, 15 direct IDoc or RFC connections retained for legacy EDI, and 8 file-based flows that are marked for retirement in Wave 2.
...
| Target system | Group analytics warehouse |
