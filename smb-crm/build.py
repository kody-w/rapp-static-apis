#!/usr/bin/env python3
"""Static Dataverse-shaped CRM API for a SMALL BUSINESS tenant — Maple & Sons Plumbing, SYNTHETIC (rapp-static-api/1.0).
Same generator as customer360; the seed is a 9-person plumbing company so owner routines (follow-ups, review
replies, invoice chasing) find customer records that match the rappter-prompts starter pack.
...
ORG_URL = "https://maple-and-sons.crm.dynamics.com"
API = "api/data/v9.2"
...
def owner():
    return {
        ...
        "_ownerid_value@OData.Community.Display.V1.FormattedValue": "Maple & Sons (synthetic)",
    }
